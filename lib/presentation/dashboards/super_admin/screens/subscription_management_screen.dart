...
import 'package:pos_desktop/presentation/controllers/subscription_plan_controller.dart';
...
class _SubscriptionManagementScreenState
  ...
  late final SubscriptionPlanController _controller;
  ...
  Future<void> _initController() async {
    ...
    if (mounted) setState(() => _isControllerReady = true);
  }
          ...
          AppButton(
            ...
            onPressed: () {
              if (formKey.currentState!.validate()) {
                ...
                _controller.updatePlan(plan.id.toString(), planData);
                Navigator.pop(ctx);
              }
            },
          ),
  ...
  void _deletePlan(SubscriptionPlanEntity plan) async {
    ...
    if (confirm == true && mounted) {
      await _controller.deletePlan(plan.id.toString());
    }
  }
